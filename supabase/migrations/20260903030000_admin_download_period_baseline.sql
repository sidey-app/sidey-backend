...
-- The first observation for an asset is a cumulative baseline. Keep it in the
-- all-time total, but do not attribute the pre-observation history to the day
-- on which the collector first saw the asset.
